...
void plusMinus(int arr_count, int arr) {
    ...
    posCount = posCountarr_count;
    negCount = negCountarr_count;
    zeroCount = zeroCountarr_count;
    
    if (zeroCount+posCount+negCount == 1.0) {
        printf(%lfn, posCount);
        printf(%lfn, negCount);
        printf(%lfn, zeroCount);
    } else {
        printf(Error!n);  
    }
}
...
// 0.333333
// 0.166667
>>>>>>> 673d65153642128354e075520e8719098edbba00
